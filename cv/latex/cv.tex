...
\vspace{10pt}
\section*{Profile}
Solution oriented and analytical Infrastructure Engineer with extensive experience in AWS, database and Linux administration. Works to continually improve services as well as automate processes, creating reliable, re-usable and leading edge DevOps practices and tools.
Experience includes work with consultancies, startups, and large corporates, across a wide variety of industries.\\\\
Would consider exploratory conversations around Platform, Infrastructure, DevOps, or DataOps roles which include, amongst others, the technologies outlined in the \textit{Core Technologies  \& Skills} section.
...
AWS VPC, ECS, RDS&$\bs\bs\bs\bs\bs$&Used in core business services\\
AWS Cloudformation&$\bs\bs\bs\bs\bs$&Extensive use of AWS infrastructure as code\\
AWS CDK&$\bs\square\square\square\square$&Partial migration of Cloudformation to CDK\\
CI/CD&$\bs\bs\bs\bs\square$&Continuous Delivery using the above tools and CircleCI\\
Docker, LXD&$\bs\bs\bs\bs\square$&Docker used in AWS CI/CD pipeline\\
Python \& BASH&$\bs\bs\bs\bs\square$&General scripting including use in CI/CD pipelines\\
MySQL \& PostgreSQL&$\bs\bs\bs\bs\bs$&Replication, stored procedures, \& problem solving\\
SaltStack&$\bs\bs\bs\bs\square$&Extensive use for configuration management\\
RabbitMQ, Logstash, Elasticsearch&$\bs\bs\bs\square\square$&Responsible for production deployments, configuration, \& maintenance\\
Prometheus, Grafana, Graphite&$\bs\bs\bs\bs\square$&Responsible for production use of these monitoring tools\\
...
\end{minipage}
Working at The Mobility House has, thus far, afforded me the opportunity of\\ &working on a variety of projects - delivering value through the use of AWS tools such as CloudFormation, Elastic Container Service (Fargate), and others. Full continuous delivery involving GitHub, CircleCI, Docker, CloudFormation, and Fargate. Further tools in the stack include SaltStack, RabbitMQ, Logstash, Elasticsearch, Prometheus, and Grafana (deployed with CloudFormation on ECS Fargate with a (PostgreSQL) RDS backend.)\\ &In early 2020 I was made team-lead for the Cloud Infrastructure/DevOps team.\\\\\\
